...
## Project Structure
    ...
    ├── testapiautosetting_126627  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126627`
...
2. Clone this repo and `cd testapiautosetting_126627`
